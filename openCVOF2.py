...
def processFlow(export_dir, video_filename, maxFrameNum=9999, res=[1080,1920], displayFlow=False, method='deepflow'):
    res = np.array(res)
    ...
    #print (res, frame1)
    print (frame1)
    prvsFrame = cv.cvtColor(np.uint8(frame1), cv.COLOR_BGR2GRAY)
